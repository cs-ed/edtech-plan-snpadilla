...
At the beginning of each class, the teacher will provide a recap of the previous lesson by using the Screenshare feature on Zoom. Then during the main instruction, the teacher will guide the students through the lesson by playing the short videos from the [projectstem.org](projectstem.org) curriculum. Often times, the teacher will pause the screen, use the annotate button, and mark on the screen to point out key points or important details that the students should look out for during their work time. This step is critical to reach all learners since merely playing a video and having students synthesize its purpose on their own is usually not efficient. Taking the step to pause and break down key steps in the process will aid English learners in their understanding of the concepts. Also, the instruction in the video may generally be too fast-paced for new students in computer science. Slowing it down or pausing the video to allow students to process the concepts would be beneficial. After providing instruction, the students will link onto the [projectstem.org](projectstem.org) website using the system allocated usernames and passwords. On projectstem, the students will review their tasks and go on to [scratch.mit.edu](scratch.mit.edu) to complete their activities during the first two blocks of the curriculum. In the future, they will continue on to [code.org](code.org). Since the teacher is unable to see students working in real time while they are on the projectstem website or while they go on to their independent work on [scratch.mit.edu](scratch.mit.edu), the teacher has the option to turn on the Netop software, which enables the teacher to view the individual student's desktop. This is possible as long as the students are using Google Classroom. By using this, the teacher is able to redirect the student to correct their behavior or off-task activity.

As working collaboratively is a skill significant to a student's development in Computer Science and beyond, some of the projects require pair programming while others are individual-based activities. In [projectstem](projectstem.org), students are taught the concept of paired programming in which each partner takes turns being either the driver or the navigator. In order to facilitate this in a virtual learning environment, students are paired up and provided a dedicated break out room for a specific assignment. During the break out rooms, the students will take turns each as a driver or a navigator. The driver is responsible for adding the program created in the [Scratch](scratch.mit.edu) program to the class studio so that the teacher can review the outcome of each paired activity. The "screen share" feature must be open for students in order for them to execute this practice. Moreover, this is why it is important for each student to have a working camera and a computer that can handle more than one application at a time. Essentially, the audio capabilities are vital so that the students can hear the teacher and their classmates.

Another way that students can work collaboratively is by using the "remix" feature in [Scratch](scratch.mit.edu). With this feature, each student in a group can all begin with the same starter code. After clicking on "remix," each student can modify the code and share with each other how they decided to solve a problem or debug a program. They can share using the "screen share" feature in Zoom or by copying the code in the chat for their partner(s). The teacher changes partnerships every two weeks so that the students are provided enough time to feel comfortable getting acquainted with up to 3 other classmates, while also providing opportunities to develop collaboration skills by working with a variety of different personalities. Working collaboratively also makes the class inclusive, especially in terms of gender biases. Students, whether female, male, or nonbinary are expected to work alongside each other without hesitation. In addition, to ensure that students are successful, students who are have been impacted in the past due to the digital divide are provided the equipment necessary to complete their work in a similar manner as any student who is not impacted by any financial burden.

It is important to note that each class period is 50 minutes long so assignments are not always completed during that time allotment; however, students are given until the next class meeting to complete their activities (this class meets on Mondays and Thursdays). There is also an option of returning during a teacher's extended learning time or office hours to reach out to the teacher or other class mates for assistance live on Zoom. Extended learning is provided 30 minutes a day, four days a week, while office hours are once a week for an hour every Wednesday.

With the [projectstem](projectstem.org) curriculum, the students are given a quiz mid-unit and a project to complete at the end of the unit. Students may re-take the quizzes any time during the trimester to improve their grade, which is an accommodation for virtual learning. Each unit consists of 10 lessons. Although the quizzes are automatically graded, the teacher needs to input the grades onto Google Classroom so that the student and their parents can see feedback on their quiz. As students complete their projects in [Scratch](scratch.mit.edu), they add their work to the class studio for that lesson. Since these lessons are to provide the students practice for their culminating project at the end of the unit and to prepare them for their quiz, the assignments are given credit or no credit. The evidence used for the student's final grade will be the quiz and final project. Students must also present their final project to the class for each unit as part of their grade. Grades are then transferred from Google Classroom to PowerSchool through the use of the Grade Transferer software. Once the grades are transferred, the parents can go to the Parent Portal in PowerSchool and check their child's grade.
